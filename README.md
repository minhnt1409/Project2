# Project II. Resfull API

## Danh sách API 

-    [Danh sách API](https://docs.google.com/document/d/13Sg9zlCjb65Mffknu7j2rO7eHMC-WnXBdCiClAM3uCg/edit){target="_blank"}
...
- **Link**:
    ```
    http://localhost:3000/room/get_list_rooms
    ```
- **Type**: GET
- **Request**:
